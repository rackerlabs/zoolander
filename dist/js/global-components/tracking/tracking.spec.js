...
describe('Zoolander Tracking Module', function () {
  ...
  describe('tracking', function () {
    ...
    it('should track call clicks', function () {
      $('body').append('<a class="track-ceilingCall">Call</a>').append('<a class="track-pageCall">In-Page Call</a>').append('<a class="track-ceilingCall"><span>Span Call</span></a>').append('<a class="track-pageCall"><span>Span In-Page Call</span></a>');
      ...
      $('.track-ceilingCall span').trigger('click');
      expected = {
        event: 'rs.call_click',
        eventCategory: 'Infinity Tracking Triggers',
        eventAction: 'Call Click CTA - Eyebrow',
      ...
      expect(window.dataLayer.pop(), 'to include ceiling call event').to.eql(expected);
      $('.track-pageCall span').trigger('click');
      expected = {
        event: 'rs.call_click',
        eventCategory: 'Infinity Tracking Triggers',
        eventAction: 'Call Click CTA - Page',
    ...
    it('should track content activation links', function () {
      $('body').append('<a class="track-caModalOpen" data-target="#gated-content">Content Activation Modal Open</a>').append('<a class="track-caSidebarLink" data-iframe-src="https://www.youtube.com/watch?v=oHg5SJYRHA0">Content Activation Sidebar Link Click</a>').append('<a class="track-caModalOpen" data-target="#gated-content"><span>Content Activation Modal Open</span></a>').append('<a class="track-caSidebarLink" data-iframe-src="https://www.youtube.com/watch?v=oHg5SJYRHA0"><span>Content Activation Sidebar Link Click</span></a>');
      Zoolander.Tracking.init();
      ...
      expect(expected).to.deep.eql(window.dataLayer.pop());
      $('.track-caModalOpen span').trigger('click');
      expected = {
        event: 'ga.event',
        eventCategory: 'Content Activation',
        eventAction: 'Modal Click',
      ...
      expect(expected).to.deep.eql(window.dataLayer.pop());
      $('.track-caSidebarLink span').trigger('click');
      expected = {
        event: 'ga.event',
        eventCategory: 'Content Activation',
        eventAction: 'Sidebar Link Click',
    ...
    it('should track login clicks', function () {
      $('body').append('<a class="track-loginMyRack">MyZoolander Portal</a>').append('<a class="track-loginFaws">FAWS</a>').append('<a class="track-loginApps">Apps</a>').append('<a class="track-loginCloudOffice">Cloud Office</a>').append('<a class="track-loginOnePortal">Login One</a>').append('<a class="track-loginCloudCp">Cloud Control Panel</a>').append('<a class="track-loginGcp">GCP Login</a>').append('<a class="track-loginMyRack"><span>MyZoolander Portal</span></a>').append('<a class="track-loginFaws"><span>FAWS</span></a>').append('<a class="track-loginApps"><span>Apps</span></a>').append('<a class="track-loginCloudOffice"><span>Cloud Office</span></a>').append('<a class="track-loginOnePortal"><span>Login One</span></a>').append('<a class="track-loginCloudCp"><span>Cloud Control Panel</span></a>').append('<a class="track-loginGcp"><span>GCP Login</span></a>');
      Zoolander.Tracking.init();
      ...
      expect(expected).to.eql(window.dataLayer.pop());
      $('.track-loginMyRack span').trigger('click');
      expected = {
        event: 'ga.event',
        eventCategory: 'Login',
        eventAction: 'Click',
      ...
      expect(expected).to.deep.eql(window.dataLayer.pop());
      $('.track-loginApps span').trigger('click');
      expected = {
        event: 'ga.event',
        eventCategory: 'Login',
        eventAction: 'Click',
      ...
      expect(expected).to.deep.eql(window.dataLayer.pop());
      $('.track-loginFaws span').trigger('click');
      expected = {
        event: 'ga.event',
        eventCategory: 'Login',
        eventAction: 'Click',
      ...
      expect(expected).to.deep.eql(window.dataLayer.pop());
      $('.track-loginCloudOffice span').trigger('click');
      expected = {
        event: 'ga.event',
        eventCategory: 'Login',
        eventAction: 'Click',
      ...
      expect(expected).to.eql(window.dataLayer.pop());
      $('.track-loginCloudCp span').trigger('click');
      expected = {
        event: 'ga.event',
        eventCategory: 'Login',
        eventAction: 'Click',
      ...
      expect(expected).to.eql(window.dataLayer.pop());
      $('.track-loginGcp span').trigger('click');
      expected = {
        event: 'ga.event',
        eventCategory: 'Login',
        eventAction: 'Click',
      ...
      expect(expected).to.eql(window.dataLayer.pop());
      $('.track-loginOnePortal span').trigger('click');
      expected = {
        event: 'ga.event',
        eventCategory: 'Login',
        eventAction: 'Click',
    ...
    it('should track form cta clicks', function () {
      $('body').append('<a class="track-ceilingEmail">Email</a>').append('<a class="track-secondCTA">Secondary CTA</a>').append('<a class="track-subnavEmail">Subnav CTA</a>').append('<a class="track-pageEmail">In-Page CTA</a>').append('<a class="track-ceilingEmail"><span>Email</span></a>').append('<a class="track-secondCTA"><span>Secondary CTA</span></a>').append('<a class="track-subnavEmail"><span>Subnav CTA</span></a>').append('<a class="track-pageEmail"><span>In-Page CTA</span></a>');
      Zoolander.Tracking.init();
      ...
      expect(expected, '.track-ceilingEmail').to.eql(window.dataLayer.pop());
      ...
      expect(expected).to.eql(window.dataLayer.pop());
      $('.track-ceilingEmail span').trigger('click');
      expected = {
        event: 'ga.event',
        eventCategory: 'Site Submission',
        eventAction: 'Form Click CTA - Eyebrow',
      ...
      expect(expected, '.track-ceilingEmail').to.eql(window.dataLayer.pop());
      $('.track-secondCTA span').trigger('click');
      expected = {
        event: 'ga.event',
        eventCategory: 'Site Submission',
        eventAction: 'Form Click CTA - Secondary CTA',
      ...
      expect(expected).to.eql(window.dataLayer.pop());
      $('.track-subnavEmail span').trigger('click');
      expected = {
        event: 'rs.form_click',
        eventCategory: 'Site Submission',
        eventAction: 'Form Click CTA - Subnav',
      ...
      expect(expected).to.eql(window.dataLayer.pop());
      $('.track-pageEmail span').trigger('click');
      expected = {
        event: 'rs.form_click',
        eventCategory: 'Site Submission',
        eventAction: 'Form Click CTA - Page',
    ...
    it("should track 'back to top' clicks", function () {
      $('body').append('<a class="track-backToTop">Back To Top</a>').append('<a class="track-backToTop"><span>Back To Top</span></a>');
      Zoolander.Tracking.init();
      ...
      expect(expected).to.eql(window.dataLayer.pop());
      $('.track-backToTop span').trigger('click');
      expected = {
        event: 'ga.event',
        eventCategory: 'Page-Level Interactions',
        eventAction: 'Click Back to Top',
    ...
    it('should track signup CTA clicks', function () {
      ...
      $('body').append('<a class="track-signupCTA link11" href="https://cart.rackspace.com/cloud"><span>Cloud</span></a>');
      $('body').append('<a class="track-signupCTA link22" href="https://cart.rackspace.com/aws?_ga=abc123"><span>AWS</span></a>');
      $('body').append('<a class="track-signupCTA link33" href="https://cart.rackspace.com/gcp"><span>GCP</span></a>');
      Zoolander.Tracking.init();
      $('body').append('<div id="rackspaceModal"><a class="track-signupCTA link4" href="https://cart.rackspace.com/office365">Office365</a></div>');
      $('body').append('<div id="rackspaceModal"><a class="track-signupCTA link44" href="https://cart.rackspace.com/office365"><span>Office365</span></a></div>');
      $('.link3').trigger('click');
      var expected = {
        event: 'ga.event',
    ...
    it('should track signup Menu clicks', function () {
    ...
    it('should track signup Menu span clicks', function () {
      $('body').append('<a class="track-signupMenu link1" href="#cloud"><span>Cloud</span></a>');
      $('body').append('<a class="track-signupMenu link2" href="#aws"><span>AWS</span></a>');
      $('body').append('<a class="track-signupMenu link3" href="#gcp"><span>GCP</span></a>');
      Zoolander.Tracking.init();
      $('body').append('<div id="rackspaceModal"><a class="track-signupMenu link4" href="#office365"><span>Office365</span></a></div>');
      $('.link3 span').trigger('click');
      var expected = {
        event: 'ga.event',
        eventCategory: 'Signup',
        eventAction: 'Signup Click Menu',
        eventLabel: 'http://localhost:9876/context.html#gcp',
        eventValue: '0',
        eventNonInteraction: 0
      };
      expect(expected).to.eql(window.dataLayer.pop());
      ...
      expected = {
        ...
        eventCategory: 'Signup',
        eventAction: 'Signup Click Menu',
        eventLabel: 'http://localhost:9876/context.html#cloud',
        eventValue: '0',
        eventNonInteraction: 0
      };
      expect(expected).to.eql(window.dataLayer.pop());
      ...
      expected = {
        ...
        eventCategory: 'Signup',
        eventAction: 'Signup Click Menu',
        eventLabel: 'http://localhost:9876/context.html#aws',
        eventValue: '0',
        eventNonInteraction: 0
      };
      expect(expected).to.eql(window.dataLayer.pop());
      ...
      expected = {
        ...
        eventCategory: 'Signup',
        eventAction: 'Signup Click Menu',
        eventLabel: 'http://localhost:9876/context.html#office365',
        eventValue: '0',
        eventNonInteraction: 0
      };
      expect(expected).to.eql(window.dataLayer.pop());
    ...
    it('should track resource span clicks', function () {
      $('body').append('<a class="track-cta link1" href="#https://rackspace.com"><span>View Resource</span></a>');
      $('body').append('<a class="track-cta link2" href="#https://cart.rackspace.com"><span>View Cart</span></a>');
      $('body').append('<a class="track-cta link3" href="#https://blog.rackspace.com"><span>View Blog</span></a>');
      Zoolander.Tracking.init();
      $('body').append('<div id="rackspaceModal"><a class="track-cta link4" href="#https://support.rackspace.com"><span>View Support</span></a></div>');
      $('.link2 span').trigger('click');
      var expected = {
        event: 'cta.click',
        eventCategory: 'CTA',
        eventAction: 'CTA Click',
    ...
    it('should set label to nested span contents', function () {
      $('body').append('<a class="track-cta" href="https://rackspace.com"><span>These are my contents</span></a>');
      Zoolander.Tracking.init();
      $('.track-cta').trigger('click');
      var expected = {
        event: 'cta.click',
        eventCategory: 'CTA',
        eventAction: 'CTA Click',
        eventLabel: 'These are my contents',
        eventValue: '0',
        eventNonInteraction: 0
      };
      expect(expected).to.eql(window.dataLayer.pop());
    ...
    it('should track internal nav clicks', function () {
      ...
      expect(expected, 'base lvl click').to.deep.eql(result); // click mid level
      ...
      expect(expected, 'Mid lvl click').to.deep.eql(result); // click mid level span non link

      $('.item-b').trigger('click');
      var expectLength = 0;
      result = window.dataLayer.length;
      expect(expectLength, 'datalayer length').to.eql(result); // click top level link
      ...
      result = window.dataLayer.pop();
      expect(expected, 'top lvl click').to.deep.eql(result); // click span inside top level link

      $('.item-iv .navbar-topLink span').trigger('click');
      expected = {
        event: 'ga.event',
        eventCategory: 'Internal Links',
        eventAction: 'Link Click - Navigation',
        eventLabel: 'Top lvl fourth',
        eventValue: 0,
        eventNonInteraction: 0
      };
      result = window.dataLayer.pop();
      expect(expected, 'top lvl click').to.deep.eql(result); // click top level menu item
