...
lib.ssMetadata = [
    {name:"Rackspace_Responsive_Hero_atlas_", frames: [[962,0,50,50],[0,962,734,911],[736,962,285,500],[736,1464,261,475],[0,1875,101,135],[0,0,960,960]]}
];
...
(lib.ClipGroup = function(mode,startPosition,loop) {
  ...
  mask.setTransform(339.7,421.575);
...
(lib.BigMaze = function(mode,startPosition,loop) {
  this.initialize(mode,startPosition,loop,{loop:199});
  ...
  // actions tween:
  this.timeline.addTween(cjs.Tween.get(this).wait(537).call(this.frame_537).wait(319));

  // Mask (mask)
  var mask = new cjs.Shape();
  mask._off = true;
  mask.graphics.p("EggWAVaMAAAgqzMBAtAAAMAAAAqzg");
  mask.setTransform(157.05,157.075);
  ...
  this.timeline.addTween(cjs.Tween.get(this.maze).wait(505).to({_off:false},0).to({regY:480.1,x:109.7,y:289.25,alpha:1},32).to({regY:479.9,x:245.85,y:282},129).to({x:285.95,y:279.95,alpha:0},38).to({_off:true},1).wait(151));
  ...
  this.timeline.addTween(cjs.Tween.get(this.maze_1).wait(328).to({_off:false},0).to({regY:480.1,x:113.8,y:289.5,alpha:1},38).to({regY:479.9,x:252.2,y:280},139).to({x:285.95,y:279.95,alpha:0},32).to({_off:true},1).wait(318));
  ...
  this.timeline.addTween(cjs.Tween.get(this.maze_2).wait(167).to({_off:false},0).to({regY:480.1,x:109.7,y:289.25,alpha:1},32).to({regY:479.9,x:245.85,y:282},129).to({x:285.95,y:279.95,alpha:0},38).to({_off:true},1).wait(489));
  ...
  this.timeline.addTween(cjs.Tween.get(this.maze_3).to({x:252.2,y:280},167).to({x:285.95,y:279.95,alpha:0},32).to({_off:true},1).wait(656));
...
(lib.arrowLine23 = function(mode,startPosition,loop) {
  ...
  this.timeline.addTween(cjs.Tween.get(this.arrowHead).to({guide:{path:[11.9,11.6,51.7,50.6,57.7,57.1,61.8,61.5,62.8,63.4,64.5,66.8,64.5,73.1,64.5,96.2,64.5,119.2,64.5,127.8,67.6,134.7,70.3,140.8,75.9,146.2,80.4,150.6,83.1,153.3], orient:'auto'}},44).wait(35).to({alpha:0},30).to({_off:true},1).wait(1));
  ...
  this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:-20.6715,y:26.2109}).wait(1).to({graphics:mask_graphics_1,x:-19.3456,y:27.5415}).wait(1).to({graphics:mask_graphics_2,x:-18.0196,y:28.8722}).wait(1).to({graphics:mask_graphics_3,x:-16.6937,y:30.2029}).wait(1).to({graphics:mask_graphics_4,x:-15.3677,y:31.5336}).wait(1).to({graphics:mask_graphics_5,x:-14.0418,y:32.8643}).wait(1).to({graphics:mask_graphics_6,x:-12.7158,y:34.195}).wait(1).to({graphics:mask_graphics_7,x:-11.3899,y:35.5257}).wait(1).to({graphics:mask_graphics_8,x:-10.0639,y:36.8564}).wait(1).to({graphics:mask_graphics_9,x:-8.738,y:38.1871}).wait(1).to({graphics:mask_graphics_10,x:-7.412,y:39.5178}).wait(1).to({graphics:mask_graphics_11,x:-6.0861,y:40.8485}).wait(1).to({graphics:mask_graphics_12,x:-4.7601,y:42.1792}).wait(1).to({graphics:mask_graphics_13,x:-3.4341,y:43.5099}).wait(1).to({graphics:mask_graphics_14,x:-2.1082,y:44.8406}).wait(1).to({graphics:mask_graphics_15,x:-0.7822,y:46.1713}).wait(1).to({graphics:mask_graphics_16,x:0.5437,y:47.502}).wait(1).to({graphics:mask_graphics_17,x:1.8697,y:48.8327}).wait(1).to({graphics:mask_graphics_18,x:3.1956,y:50.1634}).wait(1).to({graphics:mask_graphics_19,x:4.5216,y:51.4941}).wait(1).to({graphics:mask_graphics_20,x:5.9041,y:52.8814}).wait(1).to({graphics:mask_graphics_21,x:6.9045,y:53.8788}).wait(1).to({graphics:mask_graphics_22,x:7.9053,y:54.8766}).wait(1).to({graphics:mask_graphics_23,x:8.9061,y:55.8744}).wait(1).to({graphics:mask_graphics_24,x:9.9069,y:56.8722}).wait(1).to({graphics:mask_graphics_25,x:10.9076,y:57.87}).wait(1).to({graphics:mask_graphics_26,x:11.9084,y:58.8678}).wait(1).to({graphics:mask_graphics_27,x:12.9092,y:59.8656}).wait(1).to({graphics:mask_graphics_28,x:13.91,y:60.8634}).wait(1).to({graphics:mask_graphics_29,x:14.9108,y:61.8612}).wait(1).to({graphics:mask_graphics_30,x:15.9115,y:62.859}).wait(1).to({graphics:mask_graphics_31,x:16.9123,y:63.8568}).wait(1).to({graphics:mask_graphics_32,x:17.9131,y:64.8546}).wait(1).to({graphics:mask_graphics_33,x:18.9139,y:65.8524}).wait(1).to({graphics:mask_graphics_34,x:19.9146,y:66.8502}).wait(1).to({graphics:mask_graphics_35,x:20.9154,y:67.848}).wait(1).to({graphics:mask_graphics_36,x:21.8188,y:68.8897}).wait(1).to({graphics:mask_graphics_37,x:23.1542,y:70.2187}).wait(1).to({graphics:mask_graphics_38,x:24.49,y:71.5482}).wait(1).to({graphics:mask_graphics_39,x:25.8259,y:72.8777}).wait(1).to({graphics:mask_graphics_40,x:27.1617,y:74.2072}).wait(1).to({graphics:mask_graphics_41,x:28.4976,y:75.5367}).wait(1).to({graphics:mask_graphics_42,x:29.8335,y:76.8662}).wait(1).to({graphics:mask_graphics_43,x:31.1693,y:78.1956}).wait(1).to({graphics:mask_graphics_44,x:32.5765,y:79.455}).wait(67));
  ...
  this.timeline.addTween(cjs.Tween.get(this.line2).wait(79).to({alpha:0},30).to({_off:true},1).wait(1));
...
(lib.arrowLine22 = function(mode,startPosition,loop) {
  ...
  this.timeline.addTween(cjs.Tween.get(this.arrowHead).to({guide:{path:[11.9,11.6,51.7,50.6,57.7,57.1,61.8,61.5,62.8,63.4,64.5,66.8,64.5,73.1,64.5,96.2,64.5,119.2,64.5,127.8,67.6,134.7,70.3,140.8,75.9,146.2,80.4,150.6,83.1,153.3], orient:'auto'}},44).wait(15).to({alpha:0},30).wait(1));
  ...
  this.timeline.addTween(cjs.Tween.get(this.line2).wait(59).to({alpha:0},30).wait(1));
...
(lib.arrowLine15 = function(mode,startPosition,loop) {
  ...
  this.timeline.addTween(cjs.Tween.get(this.arrowHead).to({guide:{path:[11.9,11.6,17.6,17.1,23.3,22.6,47.2,46,51.5,50.6,57.5,57,60.6,62.9,64.5,70.6,64.5,79.1,64.5,102.8,64.5,126.5,64.5,130.9,65.3,133.5,66.4,137,69.5,140.1,80.2,150.8,91,161.6], orient:'auto'}},44).wait(76).to({x:91.4,y:162.05,alpha:0},29).wait(1));
  ...
  this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:-20.6715,y:26.2109}).wait(1).to({graphics:mask_graphics_1,x:-19.2794,y:27.6051}).wait(1).to({graphics:mask_graphics_2,x:-17.8873,y:28.9993}).wait(1).to({graphics:mask_graphics_3,x:-16.4951,y:30.3936}).wait(1).to({graphics:mask_graphics_4,x:-15.103,y:31.7879}).wait(1).to({graphics:mask_graphics_5,x:-13.7108,y:33.1822}).wait(1).to({graphics:mask_graphics_6,x:-12.3187,y:34.5765}).wait(1).to({graphics:mask_graphics_7,x:-10.9266,y:35.9708}).wait(1).to({graphics:mask_graphics_8,x:-9.5344,y:37.365}).wait(1).to({graphics:mask_graphics_9,x:-8.1423,y:38.7593}).wait(1).to({graphics:mask_graphics_10,x:-6.7501,y:40.1536}).wait(1).to({graphics:mask_graphics_11,x:-5.358,y:41.5479}).wait(1).to({graphics:mask_graphics_12,x:-3.9658,y:42.9422}).wait(1).to({graphics:mask_graphics_13,x:-2.5737,y:44.3365}).wait(1).to({graphics:mask_graphics_14,x:-1.1816,y:45.7307}).wait(1).to({graphics:mask_graphics_15,x:0.2106,y:47.125}).wait(1).to({graphics:mask_graphics_16,x:1.6027,y:48.5193}).wait(1).to({graphics:mask_graphics_17,x:2.9949,y:49.9136}).wait(1).to({graphics:mask_graphics_18,x:4.387,y:51.3079}).wait(1).to({graphics:mask_graphics_19,x:5.7792,y:52.7021}).wait(1).to({graphics:mask_graphics_20,x:7.1713,y:54.0964}).wait(1).to({graphics:mask_graphics_21,x:8.6041,y:55.5314}).wait(1).to({graphics:mask_graphics_22,x:9.6767,y:56.6043}).wait(1).to({graphics:mask_graphics_23,x:10.7496,y:57.6776}).wait(1).to({graphics:mask_graphics_24,x:11.8225,y:58.7509}).wait(1).to({graphics:mask_graphics_25,x:12.8954,y:59.8242}).wait(1).to({graphics:mask_graphics_26,x:13.9683,y:60.8974}).wait(1).to({graphics:mask_graphics_27,x:15.0412,y:61.9707}).wait(1).to({graphics:mask_graphics_28,x:16.1142,y:63.044}).wait(1).to({graphics:mask_graphics_29,x:17.1871,y:64.1173}).wait(1).to({graphics:mask_graphics_30,x:18.26,y:65.1906}).wait(1).to({graphics:mask_graphics_31,x:19.3329,y:66.2639}).wait(1).to({graphics:mask_graphics_32,x:20.4058,y:67.3372}).wait(1).to({graphics:mask_graphics_33,x:21.4787,y:68.4104}).wait(1).to({graphics:mask_graphics_34,x:22.4815,y:69.5549}).wait(1).to({graphics:mask_graphics_35,x:23.7944,y:70.8866}).wait(1).to({graphics:mask_graphics_36,x:25.1079,y:72.2188}).wait(1).to({graphics:mask_graphics_37,x:26.4106,y:73.6815}).wait(1).to({graphics:mask_graphics_38,x:27.8497,y:75.1121}).wait(1).to({graphics:mask_graphics_39,x:29.2893,y:76.5432}).wait(1).to({graphics:mask_graphics_40,x:30.7289,y:77.9743}).wait(1).to({graphics:mask_graphics_41,x:32.1685,y:79.4054}).wait(1).to({graphics:mask_graphics_42,x:33.6081,y:80.8365}).wait(1).to({graphics:mask_graphics_43,x:35.0477,y:82.2676}).wait(1).to({graphics:mask_graphics_44,x:36.4544,y:83.3829}).wait(106));
  ...
  this.timeline.addTween(cjs.Tween.get(this.instance).wait(120).to({regX:45.5,scaleX:1,x:45.5},0).to({alpha:0},29).wait(1));
...
(lib.arrowLine14 = function(mode,startPosition,loop) {
  ...
  this.timeline.addTween(cjs.Tween.get(this.arrowHead).to({guide:{path:[11.9,11.6,17.6,17.1,23.3,22.6,47.2,46,51.5,50.6,57.5,57,60.6,62.9,64.5,70.6,64.5,79.1,64.5,102.8,64.5,126.5,64.5,130.9,65.3,133.5,66.4,137,69.5,140.1,80.2,150.8,91,161.6], orient:'auto'}},44).wait(55).to({x:91.4,y:162.05,alpha:0},29).wait(1));
  ...
  this.timeline.addTween(cjs.Tween.get(this.instance).wait(99).to({regX:45.5,scaleX:1,x:45.5},0).to({alpha:0},29).wait(1));
...
(lib.linesShort = function(mode,startPosition,loop) {
  ...
  this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(59).to({_off:false},0).wait(92));
  ...
  this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(39).to({_off:false},0).wait(112));
  ...
  this.timeline.addTween(cjs.Tween.get(this.line2).wait(19).to({_off:false},0).wait(132));
  ...
  this.timeline.addTween(cjs.Tween.get(this.line1).wait(1).to({_off:false},0).wait(150));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-78.5,-27.2,428.1,192.89999999999998);
...
(lib.Rackspace_Responsive_Hero = function(mode,startPosition,loop) {
  ...
  this.timeline.addTween(cjs.Tween.get(this.bigR).wait(1));
...
p.nominalBounds = new cjs.Rectangle(334.5,46.9,1411.3,1031.6);
// library properties:
lib.properties = {
